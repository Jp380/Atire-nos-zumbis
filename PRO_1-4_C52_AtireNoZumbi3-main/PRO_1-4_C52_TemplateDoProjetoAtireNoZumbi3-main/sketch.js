...
function preload(){
  ...
  bllImg = loadImage("assets/bala.png");

  ui = loadSound("assets/ui-rodrigo-faro (mp3cut.net).mp3");
  tiro = loadSound("assets/the-rock-meme (mp3cut.net).mp3");
  queisso = loadSound("assets/que-isso-meu-filho-calma-rodrigo-faro (mp3cut.net).mp3");
...
if(keyWentDown("space")){
  bll = createSprite(displayWidth-1150,player.y-30,20,10)
  bll.velocityX = 20;
  bll.addImage(bllImg);
  bll.scale = 0.16;
  
  bulletGroup.add(bll)
  player.depth = bll.depth
